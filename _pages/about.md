...
---
I am a Research Scientist at [Scale AI](https://scale.com/), where I work on LLM post-training and evaluation.

On the evaluation side, I have led data curation for [PRBench](https://labs.scale.com/papers/prbench) and [DrugDiscoveryBench](https://labs.scale.com/leaderboard/drugdiscoverybench). PRBench measures how well language models handle open-ended, high-stakes work in law and finance using expert-authored tasks and detailed rubrics. DrugDiscoveryBench evaluates agents on multi-step computational and information-retrieval tasks in early-stage drug discovery. More broadly, I have extensive experience designing data programs for complex, economically valuable workflows, including synthetic-data pipelines for later-stage drug development tasks such as clinical study report authoring.
